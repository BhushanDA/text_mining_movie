...
for(i in 0:10){
  ...
  ping<-url %>%
    ...
    html_text() 
  interstellar<-c(interstellar,ping)
}
interstellar
write.csv(interstellar,file="interstellar.csv")
getwd()
write.table(interstellar,"interstellar.txt")
...
text <- readLines("interstellar.txt")
